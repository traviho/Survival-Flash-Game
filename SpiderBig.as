package  {
	...
	import flash.events.*;
	public class SpiderBig extends MovieClip{
		private var _root:*;
		public var speed:Number = 4;
		private var pushBack:int = 5;
		public var health:int = 80;
		private var staticHealth:int = 80;
		private var damage:int = 2;
		public var reloadTime:int = 28;
		private var noticeRadius:int = 250;
		...
		private function destroyThis(event:Event = null):void{
			...
			if (event == null){
				_root.createMessage("Big spider killed");
				if (bar){
